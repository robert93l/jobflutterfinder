...
import 'package:jobflutterfinder/components/job_carousel.dart';
import 'package:jobflutterfinder/components/job_list.dart';
import 'package:jobflutterfinder/models/company.dart';
import 'package:jobflutterfinder/models/job.dart';
    ...
    return Padding(
      ...
      child: Row(
        children: <Widget>[
          IconButton(
            iconSize: 40.0,
            icon: SvgPicture.asset('asset/icons/slider.svg'),
            onPressed: (){},
          ),
          Column(
            children: [
              ...
              IconButton(
                iconSize: 40.0,
                icon: SvgPicture.asset('asset/icons/settings.svg'),
                onPressed: (){},
              ),
